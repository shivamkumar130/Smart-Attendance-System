...
| GET    | `/by-student/:id`                    | Get student attendance history       |
| GET    | `/analytics?range=day\|month\|year`  | Get analytics                        |
| GET    | `/monthly-report?month=MM&year=YYYY` | Monthly report                       |
...
| ------ | ----------------- | --------------------------- |
| GET    | `/`               | Service status              |
| POST   | `/enroll-face`    | Get face embedding          |
| POST   | `/recognize-face` | Match face against database |
